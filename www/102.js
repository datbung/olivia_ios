...
/***/ "./node_modules/@ionic/core/dist/esm/es2017/build/ni878jk5.sc.entry.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/es2017/build/ni878jk5.sc.entry.js ***!
  \*****************************************************************************/
...
class Modal {
    ...
    async present() {
        ...
        return Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation);
    }
    async dismiss(data, role) {
        const dismissed = await Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation);
        if (dismissed) {
    ...
    onDidDismiss() {
        return Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.el, 'ionModalDidDismiss');
    }
    onWillDismiss() {
        return Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.el, 'ionModalWillDismiss');
    }
    hostData() {
        return {
            'no-router': true,
            'aria-modal': 'true',
            class: Object.assign({ [`${this.mode}`]: true }, Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_2__["a"])(this.cssClass)),
            style: {
...
class ModalController {
    create(options) {
        return Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["f"])(this.doc.createElement('ion-modal'), options);
    }
    dismiss(data, role, id) {
        return Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["g"])(this.doc, data, role, 'ion-modal', id);
    }
    async getTop() {
        return Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["h"])(this.doc, 'ion-modal');
    }
