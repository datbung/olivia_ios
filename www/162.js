...
/***/ "./node_modules/@ionic/core/dist/esm/es2017/build/zr4o4ivv.sc.entry.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/es2017/build/zr4o4ivv.sc.entry.js ***!
  \*****************************************************************************/
...
class ActionSheet {
    ...
    present() {
        return Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
    }
    dismiss(data, role) {
        return Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
    }
    onDidDismiss() {
        return Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.el, 'ionActionSheetDidDismiss');
    }
    onWillDismiss() {
        return Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.el, 'ionActionSheetWillDismiss');
    }
    ...
    hostData() {
        return {
            ...
            class: Object.assign({ [`${this.mode}`]: true }, Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_2__["a"])(this.cssClass), { 'action-sheet-translucent': this.translucent })
        };
    }
    render() {
...
function buttonClass(button) {
    return Object.assign({ 'action-sheet-button': true, 'ion-activatable': true, [`action-sheet-${button.role}`]: button.role !== undefined }, Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_2__["a"])(button.cssClass));
}

class ActionSheetController {
    create(options) {
        return Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["f"])(this.doc.createElement('ion-action-sheet'), options);
    }
    dismiss(data, role, id) {
        return Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["g"])(this.doc, data, role, 'ion-action-sheet', id);
    }
    async getTop() {
        return Object(_chunk_9a4a967d_js__WEBPACK_IMPORTED_MODULE_1__["h"])(this.doc, 'ion-action-sheet');
    }
