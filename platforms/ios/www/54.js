...
/***/ "./node_modules/@ionic/core/dist/esm/es2017/build/f4ov2fgy.sc.entry.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/es2017/build/f4ov2fgy.sc.entry.js ***!
  \*****************************************************************************/
...
class Item {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, childStyles, Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this.color), { 'item': true, [`${this.mode}`]: true, [`item-lines-${this.lines}`]: this.lines !== undefined, 'item-disabled': this.disabled, 'in-list': Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["d"])('ion-list', this.el), 'item-multiple-inputs': this.multipleInputs, 'ion-activatable': this.isClickable(), 'ion-focusable': true })
        };
    }
    render() {
        ...
        return [
            Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])(TagType, Object.assign({}, attrs, { class: "item-native", disabled: this.disabled, onClick: (ev) => Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["b"])(win, href, ev, routerDirection) }),
...
class ItemDivider {
    ...
    hostData() {
        return {
            class: Object.assign({}, Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this.color), { [`${this.mode}`]: true, 'item-divider-sticky': this.sticky, 'item': true })
        };
    }
    render() {
        return [
...
class Label {
    ...
    hostData() {
        const position = this.position;
        return {
            class: Object.assign({}, Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this.color), { [`${this.mode}`]: true, [`label-${position}`]: position !== undefined, [`label-no-animate`]: (this.noAnimate) })
        };
    }
...
class SkeletonText {
    ...
    hostData() {
        ...
        const inMedia = Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["d"])('ion-avatar', this.el) || Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["d"])('ion-thumbnail', this.el);
