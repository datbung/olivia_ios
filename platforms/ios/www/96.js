...
/***/ "./node_modules/@ionic/core/dist/esm/es2017/build/ksgex3rj.sc.entry.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/es2017/build/ksgex3rj.sc.entry.js ***!
  \*****************************************************************************/
...
class Range {
    constructor() {
        ...
        this.clampBounds = (value) => {
            return Object(_chunk_6d7d2f8c_js__WEBPACK_IMPORTED_MODULE_2__["i"])(this.min, value, this.max);
        };
    ...
    hostData() {
        return {
            class: Object.assign({}, Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this.color), { [`${this.mode}`]: true, 'in-item': Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["d"])('ion-item', this.el), 'range-disabled': this.disabled, 'range-pressed': this.pressedKnob !== undefined, 'range-has-pin': this.pin })
        };
    }
    render() {
        ...
        return [
            ...
            Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "range-slider", ref: el => this.rangeSlider = el },
                ticks.map(tick => (Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { style: tickStyle(tick), role: "presentation", class: {
                        'range-tick': true,
                        'range-tick-active': tick.active
                    } }))),
                Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "range-bar", role: "presentation" }),
                Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "range-bar range-bar-active", role: "presentation", style: barStyle() }),
                renderKnob(isRTL, {
                    knob: 'A',
