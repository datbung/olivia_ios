...
/***/ "./node_modules/@ionic/core/dist/esm/es2017/build/wbj4wz5k.sc.entry.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/es2017/build/wbj4wz5k.sc.entry.js ***!
  \*****************************************************************************/
...
/* harmony import */ var _chunk_f54563a4_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-f54563a4.js */ "./node_modules/@ionic/core/dist/esm/es2017/build/chunk-f54563a4.js");
...
function importHardwareBackButton(win, config) {
    const hardwareBackConfig = config.getBoolean('hardwareBackButton', Object(_chunk_f54563a4_js__WEBPACK_IMPORTED_MODULE_3__["a"])(win, 'hybrid'));
    if (hardwareBackConfig) {
        __webpack_require__.e(/*! import() */ 6).then(__webpack_require__.bind(null, /*! ./chunk-f5118fa0.js */ "./node_modules/@ionic/core/dist/esm/es2017/build/chunk-f5118fa0.js")).then(module => module.startHardwareBackButton(win));
    }
}
function importStatusTap(win, config, queue) {
    const statusTap = config.getBoolean('statusTap', Object(_chunk_f54563a4_js__WEBPACK_IMPORTED_MODULE_3__["a"])(win, 'hybrid'));
    if (statusTap) {
        __webpack_require__.e(/*! import() */ 4).then(__webpack_require__.bind(null, /*! ./chunk-75ece731.js */ "./node_modules/@ionic/core/dist/esm/es2017/build/chunk-75ece731.js")).then(module => module.startStatusTap(win, queue));
    }
}
...
function importInputShims(win, config) {
    ...
    if (inputShims) {
        __webpack_require__.e(/*! import() */ 8).then(__webpack_require__.bind(null, /*! ./chunk-fa9c017c.js */ "./node_modules/@ionic/core/dist/esm/es2017/build/chunk-fa9c017c.js")).then(module => module.startInputShims(win.document, config));
    }
}
function needInputShims(win) {
    return Object(_chunk_f54563a4_js__WEBPACK_IMPORTED_MODULE_3__["a"])(win, 'ios') && Object(_chunk_f54563a4_js__WEBPACK_IMPORTED_MODULE_3__["a"])(win, 'mobile');
}
...
class Content {
    ...
    componentWillLoad() {
        if (this.forceOverscroll === undefined) {
            this.forceOverscroll = this.mode === 'ios' && Object(_chunk_f54563a4_js__WEBPACK_IMPORTED_MODULE_3__["a"])(this.win, 'mobile');
        }
    }
    componentDidLoad() {
        this.resize();
    ...
    hostData() {
        return {
            class: Object.assign({}, Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this.color), { [`${this.mode}`]: true, 'content-sizing': Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["d"])('ion-popover', this.el), 'overscroll': !!this.forceOverscroll }),
            style: {
...
class ToolbarTitle {
    ...
    hostData() {
        ...
        return {
            class: Object.assign({ [`${mode}`]: true, [`title-${mode}`]: true }, Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this.color))
        };
    }
    render() {
        return [
...
class Toolbar {
    ...
    hostData() {
        ...
        return {
            class: Object.assign({ [`${this.mode}`]: true }, childStyles, Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this.color))
        };
    }
    render() {
        return [
