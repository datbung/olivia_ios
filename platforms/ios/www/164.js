...
/***/ "./node_modules/@ionic/core/dist/esm/es2017/build/zxlnzjcg.sc.entry.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/es2017/build/zxlnzjcg.sc.entry.js ***!
  \*****************************************************************************/
...
/* harmony import */ var _chunk_80f33f24_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-80f33f24.js */ "./node_modules/@ionic/core/dist/esm/es2017/build/chunk-80f33f24.js");
...
class Searchbar {
    ...
    debounceChanged() {
        this.ionChange = Object(_chunk_6d7d2f8c_js__WEBPACK_IMPORTED_MODULE_3__["f"])(this.ionChange, this.debounce);
    }
    valueChanged() {
    ...
    positionPlaceholder() {
        ...
        if (this.shouldAlignLeft) {
            ...
            tempSpan.innerHTML = Object(_chunk_80f33f24_js__WEBPACK_IMPORTED_MODULE_2__["a"])(this.placeholder) || '';
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({}, Object(_chunk_2f96b3d2_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this.color), { [`${this.mode}`]: true, 'searchbar-animated': animated, 'searchbar-disabled': this.disabled, 'searchbar-no-animate': animated && this.noAnimate, 'searchbar-has-value': this.hasValue(), 'searchbar-left-aligned': this.shouldAlignLeft, 'searchbar-has-focus': this.focused })
        };
    }
    render() {
        ...
        return [
            Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "searchbar-input-container" },
                Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { disabled: this.disabled, ref: el => this.nativeInput = el, class: "searchbar-input", onInput: this.onInput, onBlur: this.onBlur, onFocus: this.onFocus, placeholder: this.placeholder, type: this.type, value: this.getValue(), autoComplete: this.autocomplete, autoCorrect: this.autocorrect, spellCheck: this.spellcheck }),
