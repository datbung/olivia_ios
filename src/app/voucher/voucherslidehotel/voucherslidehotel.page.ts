...
@Component({
  selector: 'app-voucherslidehotel',
  templateUrl: 'voucherslidehotel.page.html',
  styleUrls: ['voucherslidehotel.page.scss'],
})

export class VoucherSlideHotelPage implements OnInit{
  @Input() item:any;
    userRewardData:any;
    userInfoData:any;
    CityName: string;
