...
import { NavController, AlertController, ModalController, Platform, ActionSheetController, LoadingController } from '@ionic/angular';
...
@Component({
  ...
  templateUrl: './foodaccount.page.html',
  styleUrls: ['./foodaccount.page.scss'],
})
export class FoodAccountPage {
  loginuser = null;
  username = null;
  listSupport = [];
  isShowConfirm = false;
