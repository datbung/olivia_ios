...
export class FlightComboReviewsPage implements OnInit{
  ...
  textpromotion="iVIVU Voucher | Mobile Gift";
  pointshow;
  ...
  promofunc() {
    ...
    if (se.promocode) {
      var options = {
        ...
        body: { bookingCode: 'FLIGHTCOMBO',code: se.promocode, totalAmount: se.PriceAvgPlusTAStr.toString().replace(/\./g, '').replace(/\,/g, ''),comboDetailId: this.bookCombo.ComboId,
        couponData: {
          "hotel": {
