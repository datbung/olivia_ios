...
export class HotelListMoodPage implements OnInit{
  ...
  public dataListLike = [];
  public dataList = [];
  public listHotelPrice = [];
  loginuser:any;
  public title = "";
  public loadpricedone = false;
  public page =1;
  _infiniteScroll: any;
  memberid: any;hotelId
  ...
  constructor(public platform: Platform,public navCtrl: NavController, public zone: NgZone, public authService: AuthService, 
    ...
    private fcm: FCM, private modalCtrl: ModalController ,public moodService: moodService) {
      ...
      for (let index = 0; index < se.dataList.length; index++) {
        ...
        if (se.dataList[index].DealType) {
          ...
          if (se.dataList[index].subLocation[0]) {
            item = { Avatar: se.dataList[index].avatar, Name: se.dataList[index].name, AvgPoint: se.dataList[index].avgPoint, AvgPointDisplay: se.gf.convertNumberFormat(se.dataList[index].avgPoint), dealPrice: se.dataList[index].dealPrice ? se.dataList[index].dealPrice :se.dataList[index].dealPrice , dealType: se.dataList[index].dealType, SubLocation: se.dataList[index].subLocation[0].name, Rating: se.dataList[index].rating, HotelId: se.dataList[index].id, Liked: itemlike, IsShowPrice: se.dataList[index] ? se.dataList[index].isShowPrice : 0,regionName: this.dataList[index].regionName,regionId: this.dataList[index].regionId };
          } else {
            item = { Avatar: se.dataList[index].avatar, Name: se.dataList[index].name, AvgPoint: se.dataList[index].avgPoint, AvgPointDisplay: se.gf.convertNumberFormat(se.dataList[index].avgPoint), dealPrice: se.dataList[index].dealPrice ? se.dataList[index].dealPrice:se.dataList[index].dealPrice, dealType: se.dataList[index].dealType, SubLocation: '', Rating: se.dataList[index].rating, HotelId: se.dataList[index].id, Liked: itemlike, IsShowPrice: se.dataList[index] ? se.dataList[index].isShowPrice :0,regionName: this.dataList[index].regionName,regionId: this.dataList[index].regionId };
          }
        }
        else {
          if (se.dataList[index].subLocation[0]) {
            item = { Avatar: se.dataList[index].avatar, Name: se.dataList[index].name, AvgPoint: se.dataList[index].avgPoint, AvgPointDisplay: se.gf.convertNumberFormat(se.dataList[index].avgPoint), dealPrice: se.dataList[index].dealPrice ?se.dataList[index].dealPrice:se.dataList[index].dealPrice, dealType: se.dataList[index].dealType, SubLocation: se.dataList[index].subLocation[0].name, Rating: se.dataList[index].rating, HotelId: se.dataList[index].id, RoomNameSubString: "", MinPriceOTAStr: se.dataList[index].MinPriceOTAStr, PromotionDescriptionSubstring: "" , Liked: itemlike, IsShowPrice: se.dataList[index] ? se.dataList[index].isShowPrice : 0,regionName: this.dataList[index].regionName,regionId: this.dataList[index].regionId};
          } else {
            item = { Avatar: se.dataList[index].avatar, Name: se.dataList[index].name, AvgPoint: se.dataList[index].avgPoint, AvgPointDisplay: se.gf.convertNumberFormat(se.dataList[index].avgPoint), dealPrice: se.dataList[index].dealPrice ?se.dataList[index].dealPrice:se.dataList[index].dealPrice, dealType: se.dataList[index].dealType, SubLocation: '', Rating: se.dataList[index].rating, HotelId: se.dataList[index].id, RoomNameSubString: "", MinPriceOTAStr: se.dataList[index].MinPriceOTAStr, PromotionDescriptionSubstring: "" , Liked: itemlike, IsShowPrice: se.dataList[index] ? se.dataList[index].isShowPrice : 0,regionName: this.dataList[index].regionName,regionId: this.dataList[index].regionId };
          }
        }
