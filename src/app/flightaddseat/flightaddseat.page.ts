...
@ViewChild('slideTab') sliderTab: IonSlides;
  @ViewChild('scrollFlightAddSeat') contentFlightAddSeat: IonContent;
  slideOpts = {
    loop: false,
    slidesPerView: 1,
  ...
  confirm()
  {
    ...
    //this._flightService.itemFlightCache.listSeatAhead = this.listSeatAhead;
    this._flightService.itemFlightCache.listSeatNormal = this.listSeatNormal;
    //this._flightService.itemFlightCache.listSeatBooked = this.listSeatBooked;
    //this._flightService.itemFlightCache.listReturnSeatAhead = this.listReturnSeatAhead;
    this._flightService.itemFlightCache.listReturnSeatNormal = this.listReturnSeatNormal;
    //this._flightService.itemFlightCache.listReturnSeatBooked = this.listReturnSeatBooked;
