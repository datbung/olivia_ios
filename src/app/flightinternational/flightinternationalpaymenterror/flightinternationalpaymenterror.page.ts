...
@Component({
  selector: 'app-flightinternationalpaymenterror',
  templateUrl: './flightinternationalpaymenterror.page.html',
  styleUrls: ['./flightinternationalpaymenterror.page.scss'],
})
export class FlightInternationalPaymentErrorPage implements OnInit {
