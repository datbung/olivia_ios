...
@Component({
  selector: 'app-flightinternationalpaymentdonebank',
  templateUrl: './flightinternationalpaymentdonebank.page.html',
  styleUrls: ['./flightinternationalpaymentdonebank.page.scss'],
})
export class FlightInternationalPaymentDoneBankPage implements OnInit {
  event;
