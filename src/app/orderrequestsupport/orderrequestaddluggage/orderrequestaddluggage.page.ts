  ...
  getLuggage(item) : Promise<any>{
    var se = this;
      ...
      return new Promise((resolve, reject) => {
        ...
        var options = {
          method: 'GET',
          url: C.urls.baseUrl.urlFlight + "gate/apiv1/getAncillaryByPnr?pnr="+item.ticketCode +"&airline="+se.getAirlineShortName(item.airlineName),
          timeout: 180000, maxAttempts: 1, retryDelay: 20000,
          headers: {
            "Authorization": "Basic YXBwOmNTQmRuWlV6RFFiY1BySXNZdz09",
            'Content-Type': 'application/json; charset=utf-8'
          }
