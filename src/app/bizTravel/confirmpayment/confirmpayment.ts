...
export class ConfirmPaymentPage implements OnInit {
  ...
  constructor(private navCtrl :NavController,
    ...
    public keyboard: Keyboard) { 
      ...
      //this.phoneNo = bizTravelService.bizAccount.phoneOtp.substring(6, bizTravelService.bizAccount.phoneOtp.length);
    }
  ...
  resendOTP(){
    ...
    se.presentLoading();
      if(this.jti){
        var options = {
          'method': 'POST',
          'url': C.urls.baseUrl.urlContracting +'/biz-otp-resend',
          'headers': {
