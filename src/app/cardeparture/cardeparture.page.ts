...
export class CardeparturePage implements OnInit {
  ...
  listcarname = []; titlepage; totalAdult;public loader: any; cars = [];diff_fee;ischeckseemore=true;codem=0;count=0;
    ...
    request(options, function (error, response, body) {
      ...
      se.zone.run(() => {
        ...
        if (body.status == 1 || body.status == 3) {
          se.diff_fee = body.data[0].diff_fee;
          se.seat_group_english=body.data[0].list_seats[0].seat_group_english;
