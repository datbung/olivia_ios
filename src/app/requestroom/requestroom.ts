...
export class RequestRoomPage implements OnInit{
  ...
  auth_token: any;
    ...
    ngOnInit(){
     ...
     se.searchhotel.gaComboName = se.bookCombo.HotelName;
      ...
      var se =this;
        ...
        for (let index = 0; index < se.booking.OriginalRoomClass.length; index++) {
          ...
          element.MealTypeRates.forEach(elementRate => {
            ...
            if(elementRate.Supplier == "Internal"){
              mealt.push(elementRate);
            }
          });
          
      
          if(element.Rooms[0] && mealt && mealt.length >0){
            let obj = {
        ...
        var form = JSON.stringify({
          ...
          RegionName:"",
          CheckIn: moment(se.booking.CheckInDate).format('YYYY-MM-DD'),
          CheckOut: moment(se.booking.CheckOutDate).format('YYYY-MM-DD'),
          ...
          if (error) {
            ...
            if(data.success){
              se.bookCombo.bookingcode = data.id;
               ...
               // var form1 = JSON.stringify({"HotelId":"195208","HotelName":"InterContinental Đà Nẵng Sun Peninsula Resort","RegionId":114182,"RegionName":"","CheckIn":"2022-06-20","CheckOut":"2022-06-21","CustomerName":"pham duc anh","Email":"pdanh84.it@gmail.com","Phone":"0967992800","RequestOther":"","Avatar":"https://cdn1.ivivu.com/iVivu/2019/06/17/17/avatar-icdn-resort-panorama-from-distance-cr.png","Address":"Bãi Bắc, Bán Đảo Sơn Trà, Đà Nẵng","Adult":2,"child":0,"ChildAgeStr":"","Troom":1,"UrlBookBack":"https://beta-olivia.ivivu.com/dat-combo?cid=553&fp=SGN&ci=2022-06-20&co=2022-06-21&rn=1&an=2&cn=0&cas=%27%27","HotelLink":"https://www.ivivu.com/khach-san-da-nang/intercontinental-danang-sun-peninsula-resort","RoomData":null,"Markup":"0","Username":"kmudivivu","employeeKey":"","Source":8});
              //{"HotelId":"561936","HotelName":"Vinpearl Condotel Beachfront Nha Trang","RegionId":114184,"RegionName":"","CheckIn":"2022-06-20","CheckOut":"2022-06-21","CustomerName":"pham duc anh","Email":"pdanh84.it@gmail.com","Phone":"0967992800","RequestOther":"","Avatar":"https://cdn1.ivivu.com/iVivu/2018/09/27/18/vinpearl-condotel-beach-front-nha-trang.jpg","Address":"78-80 Trần Phú, P. Lộc Thọ, Tp. Nha Trang, Khánh Hòa ","Adult":2,"child":0,"ChildAgeStr":"","Troom":1,"UrlBookBack":"https://beta-olivia.ivivu.com/dat-combo?cid=142&fp=SGN&ci=2022-06-20&co=2022-06-21&rn=1&an=2&cn=0&cas=%27%27","HotelLink":"https://www.ivivu.com/khach-san-nha-trang/vinpearl-condotel-beach-front-nha-trang","RoomData":null,"Markup":"0","Username":"kmudivivu","employeeKey":"","Source":8}
    ...
    sendRequestRoom(){
      var se = this;
         var form = JSON.stringify({
          ...
          var urlstr1 = C.urls.baseUrl.urlContracting +"/gui-yeu-cau-gia-deal";
          var options1 = {
          method: 'POST',
          url: urlstr1,
          timeout: 10000, maxAttempts: 5, retryDelay: 2000,
          ...
          form
            ...
            request(options1, function (error, response, body) {
              if(response.statusCode != 200){
                var objError ={
                    page: "requestroom",
                    func: "sendRequestRoom",
                    message : response.statusMessage,
                    content : response.body,
                    type: "warning",
                    param: JSON.stringify(options1)
                  };
                C.writeErrorLog(objError,response);
              }
              if (error) {
                error.page="requestroom";
                error.func="sendRequestRoom";
                error.param= JSON.stringify(options1);
                C.writeErrorLog(error,response);
              }else{
                var data = JSON.parse(body);
              }
