...
export class BlogPage implements OnInit{
  ...
  blog;date;title;content;arrblog=[];blogIDlike
  ...
  getdata(id,value) {
    ...
    request(options, function (error, response, body) {
      ...
      se.zone.run(() => {
        ...
        //se.blog = se.blog.replace('br', 'pre');
        ...
        se.content = se.blog.post.post_content.replace(/br/g, "pre></pre");
        ...
        setTimeout(()=>{
          $('.divcss >p  > strong:last').addClass('custom-text');
          $('.divcss >p >em > strong:first').addClass('custom-intro-text');
        },300)
