...
; ischeck=false;
  ...
  constructor(public platform: Platform, public navCtrl: NavController, public Roomif: RoomInfo,
    ...
    public loadingCtrl: LoadingController, public gf: GlobalFunction,public alertCtrl: AlertController,
    private modalCtrl: ModalController,public activityService: ActivityService) {
